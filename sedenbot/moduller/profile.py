...
# ===============================================================
@sedenify(outgoing=True, pattern="^.reserved$")
...
@sedenify(outgoing=True, pattern="^.setpfp$")
...
@sedenify(outgoing=True, pattern="^.count$")
...
@sedenify(outgoing=True, pattern=r"^.delpfp")
