...
ECEM_STRINGS = [
    ...
    "Her şeyi anladım da Çin ne amksjdjdkmdmxmxmmxmxkc",
    "Her yere atacam",
    "Işık bulursam 37478383 tane fotoğraf çekilirim mutlaka",
    "Aşkım olduğunu söylemiş miydim ??",
    "Ya salak mısın amk sjdjdkdkkdkdkdkdkd",
    ...
    "Aşkım ♥♥♥",
    "Geceden kalan",
    "Oooo kanka büyük laf soktun o nası laf sokmak amk",
    "Canımmsınn♥",
    ...
    "Aşkımaşkımm♥♥",
    "Aynen",
    "Ya siktir git djdkdmfmgöögmdmdmdmd",
    ...
    "Nsnsmsmdmdmdmskkdms",
    "İyi kiii♥♥♥♥",
    "Senin sesin yüzünden sesi kapalı attım haykırmışsın amk arkadaş gibi arkadaş kskskskskkdmsksmsmsmmdmddk",
    ...
    "Kordonun dili olsa da konuşsa (ananızı sikim bune diyecek amk)",
    "Bende serisi var sjsjskdmmsksks",
    "Abartttttt",
    "Babuş açı iyi bir de biz de zayıftık bir zamanlar",
    "Tabi koçç",
    "Yuh amk 2 sene önceydi o",
    ...
    "sadece Doğum günümde yazıyorsunuz amk",
